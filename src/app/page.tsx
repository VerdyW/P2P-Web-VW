...
export default function Home() {
  ...
  return (
    <main className="flex flex-col min-h-screen items-center">
      ...
      <div id="Home" className="flex flex-col max-h-[850px] max-2xl:max-h-[600px] max-xl:max-h-[500px] max-lg:max-h-[350px] max-md:max-h-[250px] max-sm:h-[200px] w-screen items-center">
        <img className="w-full" src="image-2.jpg" alt="image-2"></img>
        
        <div className="grid grid-cols-[1.5fr_1fr] grid-rows-1 w-11/12 pt-5 pb-5 relative bottom-32 max-lg:bottom-20 max-sm:bottom-5 max-lg:grid-rows-1 max-lg:grid-cols-1">
          <div className="text-primary_green font-bold">
          <Reveal>
          <h3 className="">Invest And Borrow</h3>
          </Reveal>
          <Reveal width="100%">
          <h3 className="relative left-20 max-sm:left-5">Peer-To-Peer</h3>
          </Reveal>
          <Reveal width="100%">
          <h3 className="relative left-40 max-sm:left-10">With Low Interest Rates</h3>
          </Reveal>
          </div>
          

          <div className="flex flex-col gap-5 justify-end items-start w-full text-primary_green font-bold max-lg:collapse">
      ...
      <div id="Unlock" className="flex items-center justify-center bg-white w-full">
        <div className="grid grid-cols-2 justify-center items-center w-11/12 mt-20 mb-20 text-primary_green gap-14 font-bold max-md:grid-cols-1 max-md:grid-rows-2 max-md:gap-2">
          <RevealRight>
          <img src="/assets/low-interest.jpg" alt="Stack of money" className=""/>
          </RevealRight>
      ...
      <div id="Steps" className="flex items-center justify-center bg-primary_green w-full max-lg:h-full">
